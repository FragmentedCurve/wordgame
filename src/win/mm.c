...
const char *TITLE_MAIN      = "Mingling Majuscules";
...
internal void update_playboard(Game game, HWND playboard)
{
	...
	case NONE:
		{
			...
			if (c == VK_RETURN) {
				...
				HWND playboard = (HWND) GetWindowLongPtr(main, INDEX_WPLAYBOARD);
